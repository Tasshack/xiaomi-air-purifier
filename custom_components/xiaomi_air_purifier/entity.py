...
@dataclass
class XiaomiAirPurifierEntityDescription:
    key: str = None
    name: str = None
    entity_category: str = None
    property_key: XiaomiAirPurifierProperty = None
    action_key: XiaomiAirPurifierAction = None
    ...
    unit_fn: Callable[[str, object], str] = None
    attrs_fn: Callable[[object, Dict]] = None


class XiaomiAirPurifierEntity(CoordinatorEntity[XiaomiAirPurifierDataUpdateCoordinator]):
    """Defines a base Xiaomi Air Purifier entity."""

    def __init__(
        self,
        coordinator: XiaomiAirPurifierDataUpdateCoordinator,
        description: XiaomiAirPurifierEntityDescription = None,
    ) -> None:
        ...
        if description:
            if description.name is not None:
               self._attr_translation_key = description.name.lower().replace(" ", "_")
    ...
    def device_info(self) -> DeviceInfo:
        """Return device information about this Xiaomi Air Purifier device."""
        return DeviceInfo(
    ...
    @property
    def device(self) -> XiaomiAirPurifierDevice:
